<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageRevenueConsultant.aspx.cs" Inherits="_2018_12_13.Views.Report.Report.pageRevenueConsultant" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="sixteen wide tablet sixteen wide computer column">
                        <div class="ui segments">
                            <div class="ui segment no-padding-bottom">
                                <h5 class="ui left floated header">Hoa Hồng Tư Vấn
                                </h5>
    ...
    <script type="text/javascript">
        ...
        function LoadData() {
            ...
            GetRevenueConsultant("/Views/Report/Report/pageRevenueConsultant.aspx/LoadData", dateFrom, dateTo, branchID.toString(), function (data) {
                RenderReportRevenueConsultant(data, "dtContentConsultant");
