<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageRevenue.aspx.cs" Inherits="_2018_12_13.Views.Report.Report.pageRevenue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="sixteen wide tablet ten wide computer column">
                        <div class="ui segments">
                            <div class="ui segment no-padding-bottom">
                                <h5 class="ui left floated header">Doanh Thu 6 Tháng Gần Nhất
                                </h5>
    ...
    <script type="text/javascript">
        ...
        function LoadDataChart() {
            ...
            GetRevenueBranch("/Views/Report/Report/pageRevenue.aspx/LoadDataChart", dateFrom, dateTo, branchID.toString(), function (data) {
                ...
                for (var i = 0; i < DataMain.length; i++) {
                    ...
                    var element = {};
                    element.key = temp_item.Month;
                    element.y = Number(temp_item.Amount);
                    dataChartPie.push(element);

                    var elementColumn = {};
                    elementColumn.label = temp_item.Month;
        ...
        function LoadTableList() {
            RenderReportSixMonth(DataMain, "dtContentReportBody");
        }
