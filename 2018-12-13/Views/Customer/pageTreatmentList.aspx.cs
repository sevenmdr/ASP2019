...
{
    public partial class pageTreatmentList : WebPageBase
    {
        ...
        public static string LoadataTreatment(int CustomerID)
        {
            DataTable dt = new DataTable();
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = confunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_LoadList]", CommandType.StoredProcedure,
        ...
        public static string DeleteItem(int id)
        {
            ...
            {
                connFunc.ExecuteDataTable("[YYY_sp_Customer_Treatment_Delete]", CommandType.StoredProcedure,
