<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageStatusList.aspx.cs" Inherits="_2018_12_13.Views.Customer.pageStatusList" %>
                    ...
                    <div class="ui two column middle aligned very relaxed stackable grid">
                        ...
                        <div class="center aligned column" style="text-align: right; padding-bottom: 0rem">
                            <div class="ui buttons">
                                <button class="ui blue basic button modalfour" data-value="fade up" onclick="addNewStatus(customerID)">Thêm Mới</button>
                            </div>
                        </div>
                    </div>
                </div>
