...
{
    public partial class pagePaymentList : WebPageBase
    {
        ...
        public static string LoadataPayment()
        {
            DataTable dt = new DataTable();
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = confunc.ExecuteDataTable("[YYY_sp_Customer_Payment_LoadList]", CommandType.StoredProcedure,
        ...
        public static string DeleteItem(int id)
        {
            ...
            {
                connFunc.ExecuteDataTable("[YYY_sp_Customer_Payment_Delete]", CommandType.StoredProcedure,
