    ...
    <div class="invoice-box">
        <table >
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                    <div class="col-6">
                                            <p><img id="logo" src="/img/logo/LogoCompany.png" style="height: 80px;"/></p>
                                            <p id="Address"></p>
                                            <p id="hotline"></p>
                                        </div>
                            </td>
            ...
            <tr class="item">
                ...
                <td id="CusName" style="text-align:left;">
                </td>
            </tr>
            ...
            <tr class="item">
                ...
                <td id="Amount" style="text-align:left;">
                </td>
            </tr>
        ...
        <div class="Total">
            <p style="padding-left: 160px;padding-right: 160px">Khách Hàng</p>
            <p style="padding-left: 160px;padding-right: 160px">Thu Ngân</p>
        </div>
    </div>
