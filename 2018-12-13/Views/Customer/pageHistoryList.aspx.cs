...
{
    public partial class pageHistoryList : WebPageBase
    {
        ...
        public static string LoadataHistory()
        {
            DataTable dt = new DataTable();
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = confunc.ExecuteDataTable("YYY_sp_Customer_History_LoadList", CommandType.StoredProcedure,
        ...
        public static string DeleteItem(int id)
        {
            ...
            {
                connFunc.ExecuteDataTable("[YYY_sp_Customer_History_Delete]", CommandType.StoredProcedure,
