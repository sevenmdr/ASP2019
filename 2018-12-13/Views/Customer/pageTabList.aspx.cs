...
{
    public partial class pageTabList: WebPageBase
    {
        ...
        public static string LoadataTab(int CustomerID)
        {
            DataTable dt = new DataTable();
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = confunc.ExecuteDataTable("YYY_sp_Customer_TabService_LoadList", CommandType.StoredProcedure,
        ...
        public static string DeleteItem(int id)
        {
            ...
            {
                connFunc.ExecuteDataTable("[YYY_sp_Customer_TabService_Delete]", CommandType.StoredProcedure,
