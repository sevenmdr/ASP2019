...
{
    public partial class pageStatusDetailDental : WebPageBase
    {
        public static string _CustomerID { get; set; }
        public static string _CurrentID { get; set; }

        public static string _dataStatusDental { get; set; }
        ...
        private void Loadata(int id)
        {
            ...
            if (dt != null)
            {
                _dataStatusDental = JsonConvert.SerializeObject(dt);
            }
            else
            {
                _dataStatusDental = "";
        ...
        public static string ExcuteData(string data)
        {
            try
            {
                StatusDetailDental DataMain = JsonConvert.DeserializeObject<StatusDetailDental>(data);
                if (_CurrentID==null)
                {
    ...
    public class StatusDetailDental
    {
