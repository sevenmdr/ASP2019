<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageScheduleList.aspx.cs" Inherits="_2018_12_13.Views.Customer.pageScheduleList" %>
                    ...
                    <div class="ui two column middle aligned very relaxed stackable grid">
                        ...
                        <div class="center aligned column" style="text-align: right; padding-bottom: 0rem">
                            <div class="ui buttons">
                                <button class="ui blue basic button modalfour" data-value="fade up" onclick="addNewSchedule(customerID)">Thêm Mới</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function LoadScheduleAjax() {
        GetDataSourceSchedule("/Views/Customer/pageScheduleList.aspx/Loadata",customerID, function (data) {
            ...
            var table = $('#dtContent').DataTable({
                ...
                "columnDefs": [
                    ...
                    { "visible": true, "targets": 2, "data": "Date_From", width: "120px", "className": "center" },
                    { "visible": true, "targets": 3, "data": "TypeName", width: "250px" },
                    { "visible": true, "targets": 4, "data": "Content"},
                    
                    
                    { "visible": true, "targets": 5, "data": "Branch", width: "150px" },
                    { "visible": true, "targets": 6, "data": "ServiceCare", width:"150px" },
                    {
                        "targets": -2,
                        "data": null,
                        "defaultContent":
            ...
            $('#dtContent tbody ').on('click', '.buttonEditClass', function () {
                ...
                editSchedule(data["ID"],customerID);
            });
            $('#dtContent tbody ').on('click', '.buttonDeleteClass', function () {
                var data = table.row($(this).parents('tr')).data();
                DeleteScheduleList(data["ID"]);
            });
    ...
    function ExecuteDeleteSchedule(id) {
        $.ajax({
            url: "/Views/Customer/pageScheduleList.aspx/DeleteItem",
            dataType: "json",
            type: "POST",
