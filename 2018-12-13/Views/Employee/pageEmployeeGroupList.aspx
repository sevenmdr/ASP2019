<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageEmployeeGroupList.aspx.cs" Inherits="_2018_12_13.Views.Employee.pageEmployeeGroupList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="ui segment" style="border: none; box-shadow: none;">
                                <div>
                                    ...
                                    <div style="float: right">
                                        <button class="ui blue basic button" data-value="fade up" onclick="return AddNewGroup()">Thêm Mới</button>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
                var divClone;
         function LoadEmployeeGroupAjax() {
        GetDataSourceGroupEmployee("/Views/Employee/pageEmployeeGroupList.aspx/Loadata", function (data) {
        ...
        promise.then(function () { ExecuteDeleteGroup(id); }, function () { });
    }
    function ExecuteDeleteGroup(id) {
        $.ajax({
            url: "/Views/Employee/pageEmployeeGroupList.aspx/DeleteItem",
            dataType: "json",
            type: "POST",
        ...
        function AddNewGroup() {
            ...
            $("#divDetailPopup").load("/Views/Employee/pageEmployeeGroupDetail.aspx");
            $('#divDetailPopup').modal('show');
            return false;
        }
             function EditGroup(CurrentID) {
                 document.getElementById("divDetailPopup").innerHTML = '';
                 $("#divDetailPopup").load("/Views/Employee/pageEmployeeGroupDetail.aspx?CurrentID=" + CurrentID);
            $('#divDetailPopup').modal('show');
            return false;
        }
    </script>
