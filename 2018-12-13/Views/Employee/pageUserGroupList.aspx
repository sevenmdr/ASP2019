<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageUserGroupList.aspx.cs" Inherits="_2018_12_13.Views.Employee.pageUserGroupList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="ui segment" style="border: none; box-shadow: none;">
                                <div>
                                    <div style="float: left">
                                        <h3>Nhóm Phân Quyền</h3>
                                    </div>
                                    <div style="float: right">
                                        <button class="ui blue basic button" data-value="fade up" onclick="return AddNewGroupUser()">Thêm Mới</button>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
                var divClone;
        function LoadUserGroupAjax() {
        GetDataSourceGroupUser("/Views/Employee/pageUserGroupList.aspx/Loadata", function (data) {
        ...
        promise.then(function () { ExecuteDeleteGroupUser(id); }, function () { });
    }
    function ExecuteDeleteGroupUser(id) {
        $.ajax({
            url: "/Views/Employee/pageUserGroupList.aspx/DeleteItem",
            dataType: "json",
            type: "POST",
        ...
        function AddNewGroupUser() {
            ...
            $("#divDetailPopup").load("/Views/Employee/pageUserGroupDetail.aspx");
            $('#divDetailPopup').modal('show');
            return false;
        }
             function EditGroupUser(CurrentID) {
                 document.getElementById("divDetailPopup").innerHTML = '';
                 $("#divDetailPopup").load("/Views/Employee/pageUserGroupDetail.aspx?CurrentID=" + CurrentID);
            $('#divDetailPopup').modal('show');
            return false;
        }
    </script>
