        ...
        function LoadEmployeeAjax() {
            ...
            var table = $('#dtContent').DataTable({
                ...
                "columnDefs": [
                    ...
                    { "visible": true, "targets": 2, "data": "Emp_Code" , width: "130px" },
                    { "visible": true, "targets": 3, "data": "Name", width: "250px" },
                    { "visible": true, "targets": 4, "data": "Phone", width: "150px" },
                    { "visible": true, "targets": 5, "data": "Email", width: "150px" },
                    { "visible": true, "targets": 6, "data": "GioiTinh", width: "120px" },
                    { "visible": true, "targets": 7, "data": "GroupName", width: "200px" },
                    { "visible": true, "targets": 8, "data": "Brithday", width: "150px" },
                    { "visible": true, "targets": 9, "data": "Address"  },
                   { "visible": true, "targets": 10, "data": "StateName" , width: "200px" },
                    {
                        "targets": -1,
                        "data": null,
                        "defaultContent":
