...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function LoadComboSchedule() {
            GetDataComboAppointmentList("/Views/Appointment/pageAppointmentInDay.aspx/LoadCombo", function (dataScheduleType, Branch) {
                LoadCombo(dataScheduleType, "cbbAppoinmentType")
                LoadCombo(Branch, "cbbBranch")

            });
        }
        function LoadAppointmentListAjax() {
            GetDataSourceAppointmentList("/Views/Appointment/pageAppointmentInDay.aspx/LoadataAppointmentList", (Number($('#ScheduleBranchID').dropdown('get value')) ? Number($('#ScheduleBranchID').dropdown('get value')) : 0), function (data) {
