<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageProductTypeList.aspx.cs" Inherits="_2018_12_13.Views.WareHouse.pageProductTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="ui segment" style="border: none; box-shadow: none;">
                                <div>
                                    ...
                                    <div style="float: right">
                                        <button class="ui blue basic button" data-value="fade up" onclick="return AddNewProductType()">Thêm Mới</button>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
                var divClone;
         function LoadProductTypeAjax() {
        GetDataSourceProductType("/Views/WareHouse/pageProductTypeList.aspx/LoadataProductType", function (data) {
        ...
        promise.then(function () { ExecuteDeleteProductTypeList(id); }, function () { });
    }
    function ExecuteDeleteProductTypeList(id) {
        $.ajax({
            url: "/Views/WareHouse/pageProductTypeList.aspx/DeleteItem",
            dataType: "json",
            type: "POST",
        ...
        function AddNewProductType() {
            ...
            $("#divDetailPopup").load("/Views/WareHouse/pageProductTypeDetail.aspx");
            $('#divDetailPopup').modal('show');
            return false;
        }
         function EditProductType(CurrentID) {
                 document.getElementById("divDetailPopup").innerHTML = '';
                 $("#divDetailPopup").load("/Views/WareHouse/pageProductTypeDetail.aspx?CurrentID=" + CurrentID);
            $('#divDetailPopup').modal('show');
            return false;
        }
    </script>
