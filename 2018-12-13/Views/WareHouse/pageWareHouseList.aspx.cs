...
{
    public partial class pageWareHouseList : System.Web.UI.Page
    {
        ...
        public static string LoadataWareHouse()
        {
        ...
        public static string DeleteItem(int id)
        {
            try
            {
                ...
                {
                    connFunc.ExecuteDataTable("[YYY_sp_Product_WareHouse_Delete]", CommandType.StoredProcedure,
