<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageNormSettingList.aspx.cs" Inherits="_2018_12_13.Views.WareHouse.pageNormSettingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="ui segment" style="border: none; box-shadow: none;">
                                <div>
                                    ...
                                    <div style="float: right">
                                        <button class="ui blue basic button" data-value="fade up" onclick="return AddNewNormSetting()">Thêm Mới</button>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function AddNewNormSetting() {
            document.getElementById("divDetailPopup").innerHTML = '';
            $("#divDetailPopup").load("/Views/WareHouse/pageNormSettingDetail.aspx");
