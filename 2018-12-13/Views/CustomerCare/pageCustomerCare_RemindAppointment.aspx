                        ...
                        <form class="ui form segment form3">
                            <div class="ui segment" style="border: none;">
                                <div class="five fields" style="margin: 0px;">
                                    ...
                                    <div class="field">
                                        <div class="ui fluid search selection dropdown" id="typetakecare"onchange="LoadDataCustomerCareRemindAppointment()">
                                            ...
                                            <div id="cbbcustomerCareType" class="menu" tabindex="-1">
                                                ...
                                                <div class="item" data-value="0">Chưa Chăm Sóc</div>
                                                                        ...
                                                                        <div class="field">
                                        <input class="flatpickr" id="DateFrom" type="text" placeholder="Select Date.." onchange="LoadDataCustomerCareRemindAppointment()" />
                                    </div>
                                    <div class="field">
                                        <input class="flatpickr" id="DateTo" type="text" placeholder="Select Date.." onchange="LoadDataCustomerCareRemindAppointment()" />
                                    </div>
...
`;
        ...
        function LoadDataCustomerCareRemindAppointment() {
            GetDataSourceCustomerCareAfterTreatment("/Views/CustomerCare/pageCustomerCare_RemindAppointment.aspx/LoadataCustomerCare", Number($('#Branch_ID').dropdown('get value')),  $("#DateFrom").val(), $("#DateTo").val(), function (data) {
                dataListMain = data;
