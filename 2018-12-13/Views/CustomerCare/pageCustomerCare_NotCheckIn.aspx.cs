...
{
    public partial class pageCustomerCare_NotCheckIn : System.Web.UI.Page
    {
    ...
    public static string LoadataCustomerCare(int Branch_ID,string Date)
    {
        ...
        using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
        {
            dt = confunc.ExecuteDataTable("[YYY_CustomerCare_GetAppointment_NotCheckIn]", CommandType.StoredProcedure,
