...
namespace _2018_12_13.Views.Service
{
    public partial class pageServiceTypeList : System.Web.UI.Page
    {
        ...
        public static string LoadataServiceType()
        {
            DataTable dt = new DataTable();
            using (Models.ExecuteDataBase confunc = new Models.ExecuteDataBase())
            {
                dt = confunc.ExecuteDataTable("YYY_sp_ServiceCate_Load", CommandType.StoredProcedure,
        ...
        public static string DeleteItem(int id)
        {
            try
            {
                ...
                {
                    connFunc.ExecuteDataTable("[YYY_sp_ServiceCate_Delete]", CommandType.StoredProcedure,
