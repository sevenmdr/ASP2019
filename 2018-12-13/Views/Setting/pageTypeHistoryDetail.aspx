<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageTypeHistoryDetail.aspx.cs" Inherits="_2018_12_13.Views.Setting.pageTypeHistoryDetail" %>
        ...
        function ExcuteData() {
           ...
           data.Note = $('#NoteHistory').val() ? $('#NoteHistory').val() : "";
            ...
            if ($('#form3').form('is valid')) {
                $.ajax({
                    url: "/Views/Setting/pageTypeHistoryDetail.aspx/ExcuteData",
                    dataType: "json",
                    type: "POST",
