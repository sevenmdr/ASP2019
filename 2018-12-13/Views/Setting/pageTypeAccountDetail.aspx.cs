...
{
    public partial class pageTypeAccountDetail : WebPageBase
    {
        ...
        private void Loadata(int id)
        {
            ...
            {
                dt = confunc.ExecuteDataTable("[YYY_sp_TypeAccount_LoadDetail]", CommandType.StoredProcedure,
            ...
            public static string ExcuteData(string data)
            {
                ...
                TypeAccount DataMain = JsonConvert.DeserializeObject<TypeAccount>(data);
                    if (_CurrentID == null)
                    {
                        ...
                        {
                            DataTable dt = connFunc.ExecuteDataTable("[YYY_sp_TypeAccount_Insert]", CommandType.StoredProcedure,
                    ...
                    else
                    {
                        using (Models.ExecuteDataBase connFunc = new Models.ExecuteDataBase())
                        {
                            DataTable dt = connFunc.ExecuteDataTable("[YYY_sp_TypeAccount_Update]", CommandType.StoredProcedure,
