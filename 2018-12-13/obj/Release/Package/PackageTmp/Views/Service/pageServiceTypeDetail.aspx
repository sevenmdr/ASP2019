...
<body>
            ...
            <div class="ui segments">
                  <form class="ui form segment form3" id="form3">
                       <div class="field">
                                ...
                                <input id="ServiceType" name="name" type="text" />
                            </div>

                    <div class="field">
                        <div class="field">
                            <label>Ghi Chú</label>
                            <textarea id="NoteServiceType" name="content"></textarea>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
         ...
         function ExcuteData() {
           ...
           data.Note = $('#NoteServiceType').val() ? $('#NoteServiceType').val() : "";
            ...
            if ($('#form3').form('is valid')) {
                $.ajax({
                    url: "/Views/Service/pageServiceTypeDetail.aspx/ExcuteData",
                    dataType: "json",
                    type: "POST",
        ...
        $(document).ready(function () {
            ...
            let dataServiceType = ([<%=_dataServiceType%>][0]);
            if (dataServiceType) {
