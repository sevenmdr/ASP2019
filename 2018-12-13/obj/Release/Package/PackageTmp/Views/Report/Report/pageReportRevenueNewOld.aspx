<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageReportRevenueNewOld.aspx.cs" Inherits="_2018_12_13.Views.Report.Report.pageReportRevenueNewOld" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="sixteen wide tablet ten wide computer column">
                        <div class="ui segments">
                            <div class="ui segment no-padding-bottom">
                                <h5 class="ui left floated header">Doanh Thu Dịch Vụ Cũ Mới
                                </h5>
                            ...
                            <div class="ui segment left aligned">
                                <table class="ui very basic center aligned  celled table">
                                    ...
                                    <tbody id="dtContentRevenueServiceOldnewBody">
                                    </tbody>
                                </table>
    ...
    <script type="text/javascript">
        ...
        function LoadDataChart() {
            ...
            GetRevenueServiceNewOld("/Views/Report/Report/pageReportRevenueNewOld.aspx/LoadData", dateFrom, dateTo, branchID.toString(), function (data) {
                ...
                for (var i = 0; i < DataMain.length; i++) {
                    ...
                    var element = {};
                    element.key = temp_item.TypeName;
                    element.y = Number(temp_item.Amount);
                    dataChartPie.push(element);

                    var elementColumn = {};
                    elementColumn.label = temp_item.TypeName;
        ...
        function LoadTableList() {
            RenderReportServiceNewOld(DataMain, "dtContentRevenueServiceOldnewBody");
        }
