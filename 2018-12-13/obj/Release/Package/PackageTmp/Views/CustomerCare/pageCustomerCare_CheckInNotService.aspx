<%@ Page Title="" Language="C#" MasterPageFile="~/Master/1_LeftNar.Master" AutoEventWireup="true" CodeBehind="pageCustomerCare_CheckInNotService.aspx.cs" Inherits="_2018_12_13.Views.CustomerCare.pageCustomerCare_CheckInNotService" %>
                        ...
                        <form class="ui form segment form3">
                            <div class="ui segment" style="border: none;">
                                <div class="five fields" style="margin: 0px;">
                                    <div class="field">
                                        <h5>Đến Nhưng Không Làm Dịch Vụ</h5>
                                    </div>
                                    <div class="field">
                                    </div>
                                    <div class="field">
                                        <div class="ui fluid search selection dropdown" id="Branch_ID" onchange="LoadDataCustomerCareNotService()">
...
`;
        ...
        function LoadDataCustomerCareNotService() {
            GetDataSourceCustomerCareAfterTreatment("/Views/CustomerCare/pageCustomerCare_CheckInNotService.aspx/LoadataCustomerCare", Number($('#Branch_ID').dropdown('get value')), $(".flatpickr").val(), function (data) {
                ...
                LoadCardView(dataListMainCheckInNotService, "cardaftertreatment")
                    ...
                    window.open("/Views/CustomerCare/pageCustomerCareList.aspx?CustomerID=" + $(this).attr('name') + "&AppID=" + $(this).val() + "&Type=2");
        ...
        function LoadComboBranchNotCheckIn() {
            GetDataComboBranch("/Views/CustomerCare/pageCustomerCare_CheckInNotService.aspx/LoadComboMain", function (data) {
