<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageTypeHistoryList.aspx.cs" Inherits="_2018_12_13.Views.Setting.pageTypeHistoryList" %>
            ...
            <div class="ui segment" style="border: none; box-shadow: none;">
                <div>
                    ...
                    <div style="float: right">
                        <button class="ui blue basic button" data-value="fade up" onclick="return AddNewTypeHistory()">Thêm Mới</button>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function LoadTypeHistoryAjax() {
        GetDataTypeHistory("/Views/Setting/pageTypeHistoryList.aspx/LoadData", function (data) {
    ...
    function ExecuteDeleteTypeHistory(id) {
        $.ajax({
            url: "/Views/Setting/pageTypeHistoryList.aspx/DeleteItem",
            dataType: "json",
            type: "POST",
    ...
    function AddNewTypeHistory() {
        ...
        $("#divDetailPopup").load("/Views/Setting/pageTypeHistoryDetail.aspx");
        $('#divDetailPopup').modal('show');
        return false;
    }
    function EditTypeHistory(CurrentID) {
        document.getElementById("divDetailPopup").innerHTML = '';
        $("#divDetailPopup").load("/Views/Setting/pageTypeHistoryDetail.aspx?CurrentID=" + CurrentID);
        $('#divDetailPopup').modal('show');
        return false;
    }
</script>
