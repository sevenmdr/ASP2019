<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pageEmployeeGroupDetail.aspx.cs" Inherits="_2018_12_13.Views.Employee.pageEmployeeGroupDetail" %>
...
<body>
    ...
    <script type="text/javascript">
        function ExcuteData() {
           ...
           data.Note = $('#NoteGroup').val() ? $('#NoteGroup').val() : "";
            ...
            if ($('#form3').form('is valid')) {
                $.ajax({
                    url: "/Views/Employee/pageEmployeeGroupDetail.aspx/ExcuteData",
                    dataType: "json",
                    type: "POST",
        ...
        $(document).ready(function () {
            ...
            let dataGroupt = ([<%=_dataGroupt%>][0]);
            if (dataGroupt) {

                $('#Group').val((dataGroupt[0].Name));
                 $('#NoteGroup').val((dataGroupt[0].Note));
            }
        }
    </script>
