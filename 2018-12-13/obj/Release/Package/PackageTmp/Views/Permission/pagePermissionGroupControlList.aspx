<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagePermissionGroupControlList.aspx.cs" Inherits="_2018_12_13.Views.Permission.pagePermissionGroupPageList" %>
            ...
            <div class="ui segment" style="border: none; box-shadow: none;">
                <div>
                    <div style="float: left">
                        <h3>Phân Quyền Nhóm Theo Màn Hình
            ...
            <table id="dtContent" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center">Tên Tên Màn Hình</th>
...
<script type="text/javascript">
    ...
    function LoadGroupControlListAjax() {
        GetDataPermissionGroupControlList("/Views/Permission/pagePermissionGroupControlList.aspx/LoadData", function (data) {
            ...
            var table = $('#dtContent').DataTable({
                ...
                "columnDefs": [
                    ...
                    { "visible": true, "targets": 1, "data": "STT", width: "50px", "className": "center" },
                     { "visible": true, "targets": 2, "data": "GroupName", width: "350px" },
                    { "visible": true, "targets": 3, "data": "Name", width: "350px" },
